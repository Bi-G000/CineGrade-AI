...
:: ============================================================================
:: build_win64_release.bat
:: ============================================================================
:: Builds the CineGrade AI project in Release configuration using Visual Studio 2022.
...
:: --------------------------------------------------------------------------
:: 2. Execute CMake Build (Multi-core via MSBuild /m)
:: --------------------------------------------------------------------------
echo [2/2] Starting optimized %CONFIG% build process...
echo.
...
echo.
echo ======================================================
echo  [SUCCESS] %CONFIG% build and packaging completed successfully!
echo  Output location: %PROJECT_ROOT%\%BUILD_DIR%\bin\%CONFIG%\
echo  UXP Package:    %PROJECT_ROOT%\%BUILD_DIR%\package\CineGradeAI\%CONFIG%\
echo ======================================================
